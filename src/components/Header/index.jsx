  ...
  const handleAvatarItemClick = (title) => {
    switch (title) {
      case "Dashboard":
        ...
        navigate(`/${accountRole.toLowerCase()}/profile`);
        break;
      case "Logout":
        logout();
        break;
        ...
        {user ? (
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-gray-500">{accountRole}</span>
            </div>
          </div>
        ) : (
          <div className="hidden lg:flex gap-3">
            <Button
              className="bg-[#2E5077] text-white hover:bg-[#4DA1A9]"
              onClick={() => navigate("/login")}
            >
              Login
            </Button>
            <Button
              className="bg-[#79D7BE] border border-white text-[#2E5077] hover:bg-[#2E5077] hover:text-white"
          ...
          <SheetContent>
            ...
            {!user && (
              <div className="mt-6 space-y-3">
                <Button
                  className="w-full bg-[#80CBC4] text-white hover:bg-[#4DA1A9] focus:ring-2 focus:ring-blue-300"
                  onClick={() => navigate("/login")}
                >
                  Login
                </Button>
                <Button
                  className="w-full border border-blue-500 text-blue-500 hover:bg-blue-400 hover:text-white focus:ring-2 focus:ring-blue-300"
                  onClick={() => navigate("/sign-up")}
                >
                  Sign Up
                </Button>
